...
This document presents the main objectives and guiding principles for the development of a web application for managing coding lessons.

## Main objectives

1.  Provide a platform to create, organize and distribute programming lessons (courses, exercises, solutions) for learners and instructors.
2.  Track individual progress: learning goals, milestones, assessments and achievement history.
...
*   Learner-centered: clear interfaces, immediate feedback, measurable progression and pedagogical recommendations.
